...
})(["width:9px;height:9px;border-radius:9px;border:2px solid ", ";position:absolute;top:-14px;left:-14px;"], function (props) {
...
})(["left:-12px;top:0.5px;height:100%;width:8px;border-right:3px solid ", ";", " ", ""], function (props) {
  return props.theme.background;
}, function (props) {
...
})(["top:-12px;left:-0.5px;width:100%;height:8px;border-bottom:3px solid ", ";", " ", ""], function (props) {
  return props.theme.background;
}, function (props) {
...
})(["padding:4px 8px;text-align:", ";"], function (props) {
  return props.align;
});
