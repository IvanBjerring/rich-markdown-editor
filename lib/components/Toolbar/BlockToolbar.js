  ...
  _createClass(BlockToolbar, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(Separator, null),
        this.renderBlockButton("table", _outlineIcons.TableIcon),
...
})(["display:flex;z-index:100;position:relative;align-items:center;background:", ";height:44px;&:before,&:after{content:\"\";position:absolute;left:-100%;width:100%;height:44px;background:", ";}&:after{left:auto;right:-100%;}@media print{display:none;}"], function (props) {
